package com.example.derek.view.circleprogress;
...
import com.example.derek.utils.UIUtils;
...
public class ArcProgress extends View {
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = UIUtils.sp2px(getResources(), 18);
        min_size = (int) UIUtils.dp2px(getResources(), 100);
        default_text_size = UIUtils.sp2px(getResources(), 40);
        default_suffix_text_size = UIUtils.sp2px(getResources(), 15);
        default_suffix_padding = UIUtils.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = UIUtils.sp2px(getResources(), 10);
        default_stroke_width = UIUtils.dp2px(getResources(), 4);
