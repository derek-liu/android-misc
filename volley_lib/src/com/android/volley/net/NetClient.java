...
import com.android.volley.net.listener.AnimationImageListener;
import com.android.volley.net.listener.CustomImageListener;
import com.android.volley.net.listener.INetClientBaseListener;
import com.android.volley.net.listener.INetClientBytesListener;
import com.android.volley.net.listener.INetClientListener;
import com.android.volley.net.listener.OnBatchLoadImageListener;
import com.android.volley.toolbox.ImageLoader;
import com.android.volley.toolbox.ImageRequest;
import com.android.volley.toolbox.StringRequest;
import com.android.volley.utils.VolleyCacheMgr;
...
public class NetClient {
     ...
     *TODO:wangwei 由于业务上暂时没有缓存的需求，所以新增该方法，如果日后需要缓存文字请求
    ...
    /**
     * 执行一个简单的请求（get方式），如果需要post方式请使用{@link com.android.volley.net.NetClient#executePostRequest}<br/>
     *
     * @param url      url
     * @param listener 请求的回调， 不能为null，否则没有意义，并抛NullPointException
     */
     ...
     * @param tag 请求tag，用于取消请求 {@link com.android.volley.net.NetClient#cancelRequest}
     * @param listener
     * @return
     */
    public Request executeGetRequest(String url, Map<String, String> headParams, Map<String, String> requestParams, boolean isShouldCache, String tag, INetClientListener listener) {
        StringRequest strRequest = mRequestFactory.produceGetStringRequest(url, headParams, makeSuccessListener(listener), makeErrorListener(listener));
        if (!isShouldCache) {
    ...
    public Request executeGetRequest(String url, Map<String, String> headParams, Map<String, String> requestParams, INetClientBytesListener listener) {
        return executeRequest(Request.Method.GET, url, headParams, null, listener, null);
    }
    ...
    /**
     * 加载图片时带动画<br/>
     * 如果不需要动画，请使用{@link com.android.volley.net.NetClient#loadImage}
     *
     * @param context   上下文
     * @param url       图片地址
     * @param imageView
     * @param options   展示图片的配置项
    ...
    /**
     * 使用imageRequest来加载图片
     * TODO:wangwei 该方法加载图片会比ImageLoader加载图片内存峰值高，建议使用{@link com.android.volley.net.NetClient#loadImage(String, android.widget.ImageView, ImageOptions)}
     *
     * @param url           图片url地址
