...
import com.android.volley.net.ImageOptions;
import com.android.volley.net.LruBitmapCache;
...
public class VolleyCacheMgr {
    ...
    private static Bitmap doParseBitmapFromCache(Cache.Entry entry, int maxWidth, int maxHeight) {
        ...
        try {
            ...
            if (actualWidth > VolleyController.sMaxWidth) {
                maxWidth = VolleyController.sMaxWidth;
            }
            if (actualHeight > VolleyController.sMaxHeight) {
                maxHeight = VolleyController.sMaxHeight;
            }
     ...
     *
     * @param data notNull
     * @return ImageOptions 注意 只有{@link ImageOptions#getMaxHeight}和{@link ImageOptions#getMaxWidth}有效
     */
